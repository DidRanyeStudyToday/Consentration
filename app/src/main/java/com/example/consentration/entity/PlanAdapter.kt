...
class PlanAdapter (var _items: ArrayList<Plan>, var _context: Context, database: DatabaseManage) : RecyclerView.Adapter<TodoListAdapter.ViewHolder>() {
